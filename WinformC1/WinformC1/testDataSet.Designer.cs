...
namespace WinformC1 {
    ...
    public partial class testDataSet : global::System.Data.DataSet {
        ...
        public partial class TestDataTable : global::System.Data.TypedTableBase<TestRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TestRow AddTestRow(string UserID, string UserName, string Password, string Email, string Tel, byte Disable) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TestRow FindByUserID(string UserID) {
        ...
        public partial class TestRow : global::System.Data.DataRow {
            ...
            public string Tel {
                get {
                    try {
                        return ((string)(this[this.tableTest.TelColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Tel\' in table \'Test\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTest.TelColumn] = value;
                }
            }
            ...
            public byte Disable {
                get {
                    return ((byte)(this[this.tableTest.DisableColumn]));
                }
                set {
                    this[this.tableTest.DisableColumn] = value;
                }
            }
            ...
            public bool IsTelNull() {
                return this.IsNull(this.tableTest.TelColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetTelNull() {
                this[this.tableTest.TelColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WinformC1.testDataSetTableAdapters {
    ...
    public partial class TestTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Test] WHERE (([UserID] = @Original_UserID) AND ([UserName] = @Original_UserName) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([Disable] = @Original_Disable))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Test] ([UserID], [UserName], [Password], [Email], [Tel], [Disa" +
                "ble]) VALUES (@UserID, @UserName, @Password, @Email, @Tel, @Disable);\r\nSELECT Us" +
                "erID, UserName, Password, Email, Tel, Disable FROM Test WHERE (UserID = @UserID)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Test] SET [UserID] = @UserID, [UserName] = @UserName, [Password] = @Password, [Email] = @Email, [Tel] = @Tel, [Disable] = @Disable WHERE (([UserID] = @Original_UserID) AND ([UserName] = @Original_UserName) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([Disable] = @Original_Disable));
SELECT UserID, UserName, Password, Email, Tel, Disable FROM Test WHERE (UserID = @UserID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WinformC1.Properties.Settings.Default.testConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, UserName, Password, Email, Tel, Disable FROM dbo.Test";
